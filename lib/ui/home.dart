  ...
  List<Widget> _buildActions() {
    return <Widget>[
      ...
      MaterialButton(
        ...
        onPressed: () {
        html.window
                .open("https://github.com/NagashreeBhat", "Github");
        },
      ),
      MaterialButton(
        child: Text(
        ...
        onPressed: () {
        html.window
                .open("https://github.com/NagashreeBhat/Resume/blob/master/NagashreeOct13.pdf", "Resume");
...
//        _buildNavigationArrows(),
  ...
  Widget _buildEducationSummary() {
    return Text(
      'A software professional with extensive experience in software design and development and Agile methodologies',
      style: TextStyles.body,
    );
  }
    ...
    return Row(
      ...
      children: <Widget>[
        GestureDetector(
          onTap: () {
            html.window
                .open("https://www.linkedin.com/in/NagashreeBhat/", "LinkedIn");
          },
          child: Image.network(
            Assets.linkedin,
            color: Color(0xFF45405B),
        ...
        GestureDetector(
          onTap: () {
            html.window.open("https://github.com/NagashreeBhat", "Github");
          },
          child: Image.network(
            Assets.google,
            color: Color(0xFF45405B),
        ...
        GestureDetector(
          onTap: () {
            html.window.open("https://twitter.com/nagashree007", "Twitter");
          },
          child: Image.network(
            Assets.twitter,
            color: Color(0xFF45405B),
